...
def solve(n_nodes, n_edges, edges):
    ...
    for count in xrange(10**9):   
        ...
        if len(optimized_solutions) > LOCAL_MINIMUM_THRESHOLD and optimized_solutions[LOCAL_MINIMUM_THRESHOLD][0] == optimized_solutions[0][0]: 
            print 'local minimum', optimized_solutions[0][:2]
